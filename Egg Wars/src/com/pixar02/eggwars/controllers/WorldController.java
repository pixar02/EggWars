...
public class WorldController {
	...
	public boolean loadWorld(String worldName){
        ...
        for(World w: EggWars.get().getServer().getWorlds()) {
    	...
    	public void unloadWorld(String w) {
    	    World world = EggWars.get().getServer().getWorld(w);
    	    if(world != null) {
    	    	EggWars.get().getServer().unloadWorld(world, true);
    	    }
    	}
    	...
    	public void deleteWorld(String name) {
    		unloadWorld(name);
    		File target = new File (EggWars.get().getServer().getWorldContainer().getAbsolutePath(), name);
    		deleteWorld(target);
    	}
